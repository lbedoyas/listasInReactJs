...
const images = [
    {
      ...
      source: 'https://cdn.pixabay.com/photo/2014/02/27/16/10/tree-276014__340.jpg',
      views: 153,
      id: 1
    },
    {
...
export class IteracionComponentes extends Component {
    render() {
        return (
...
export default IteracionComponentes
